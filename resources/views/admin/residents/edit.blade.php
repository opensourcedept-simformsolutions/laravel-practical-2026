...
@section('content')
    ...
    <form method="POST" action="{{ route('residents.update', $resident) }}" class="card p-3">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name', $resident->user->name) }}"
                required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" value="{{ old('email', $resident->user->email) }}"
                required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control" value="{{ old('phone', $resident->user->phone) }}"
                required>
        </div>
