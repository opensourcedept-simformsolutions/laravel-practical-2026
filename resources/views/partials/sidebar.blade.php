<aside class="sidebar" id="appSidebar">
  ...
  <div class="sidebar-menu">
        ...
        <x-sidebar-link :href="route('admin.complaints.index')" :active="request()->routeIs('admin.complaints.*')">
        ...
        @can('is-resident')
        <x-sidebar-link :href="route('resident.dashboard')" :active="request()->routeIs('resident.dashboard')">
            <i class="bi bi-speedometer2"></i>
            <span class="sidebar-link-label">Dashboard</span>
        </x-sidebar-link>
