...
<head>
  ...
  <style>
    ...
    .header { background: #dc3545; color: white; padding: 16px; border-radius: 4px 4px 0 0; }
...
<body>
  <div class="container">
    <div class="header">
      <h2 style="margin: 0;">Visitor Exit Notification</h2>
    </div>
    <div class="body">
      <p>Dear Resident,</p>
      <p>The visitor has exited the society premises.</p>
      ...
      <table class="table">
        ...
        <tr>
          <th>Exit Time</th>
          <td>{{ $visitorLog->exit_time?->format('d M Y h:i A') ?? 'N/A' }}</td>
        </tr>
      </table>
