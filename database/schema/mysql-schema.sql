...
CREATE TABLE `complaints` (
  ...
  `category` enum('security','cleaning','water','parking') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `deliveries` (
  ...
  `package_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('received','delivered') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'received',
...
CREATE TABLE `flats` (
  ...
  `wing` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `floor` int NOT NULL,
...
CREATE TABLE `residents` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `flat_id` bigint unsigned NOT NULL,
  `resident_type` enum('owner','tenant') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `visitor_logs` (
  ...
  `status` enum('accepted','pending','pending_approval','approved','rejected','entered','exited','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2026_07_02_145810_create_sp_admin_dashboard',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2026_07_02_150456_create_sp_dashboard_super_admin',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2026_07_02_150555_create_sp_dashboard_resident',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2026_07_02_151334_create_sp_dashboard_gatekeeper',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2026_07_03_000000_create_wings_and_add_wing_id_to_flats',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2026_07_06_093224_alter_visitor_logs_status_enum',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2026_07_06_103730_add_approved_by_to_visitor_logs_table',5);
